...
- **Elaboration timeouts from nested lemma applications** (see Pattern 2 in `docs/references/performance-optimization.md`)
...
4. `lean_diagnostic_messages(file)` per-edit
